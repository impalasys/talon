...
public final class SessionServiceGrpc {
  ...
  private static final int METHODID_COMPACT = 6;
  private static final int METHODID_DOCTOR = 7;
  private static final int METHODID_SEND_MESSAGE = 8;
  private static final int METHODID_APPEND_MESSAGE = 9;
  private static final int METHODID_UPDATE_MESSAGE = 10;
  private static final int METHODID_ANSWER_PERMISSION = 11;
  private static final int METHODID_STOP_GENERATION = 12;
  private static final int METHODID_STREAM_PARTS = 13;
  private static final int METHODID_STREAM_PARTS_BATCH = 14;
  private static final int METHODID_SUBMIT_TURN = 15;
