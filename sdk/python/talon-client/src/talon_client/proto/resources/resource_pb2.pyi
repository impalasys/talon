...
from talon_client.proto.resources import secrets_pb2 as _secrets_pb2
...
from talon_client.proto.resources import tasks_pb2 as _tasks_pb2
...
class ResourceSpec(_message.Message):
    __slots__ = ("agent", "workflow", "schedule", "channel", "channel_subscription", "connector_class", "connector", "mcp_server", "knowledge", "namespace", "session", "skill", "template", "deployment", "deployment_replica", "sandbox_class", "sandbox_policy", "sandbox", "worker", "usage_policy", "file", "task", "secret", "raw")
