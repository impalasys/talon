...
class ToolOutput(_message.Message):
    __slots__ = ("content_parts", "summary", "byte_range", "content_view_version")
    CONTENT_PARTS_FIELD_NUMBER: _ClassVar[int]
    SUMMARY_FIELD_NUMBER: _ClassVar[int]
    BYTE_RANGE_FIELD_NUMBER: _ClassVar[int]
    CONTENT_VIEW_VERSION_FIELD_NUMBER: _ClassVar[int]
    content_parts: _containers.RepeatedCompositeFieldContainer[ChatContentPart]
    summary: str
    byte_range: ToolOutputByteRange
    content_view_version: int
    def __init__(self, content_parts: _Optional[_Iterable[_Union[ChatContentPart, _Mapping]]] = ..., summary: _Optional[str] = ..., byte_range: _Optional[_Union[ToolOutputByteRange, _Mapping]] = ..., content_view_version: _Optional[int] = ...) -> None: ...

class ToolOutputByteRange(_message.Message):
    __slots__ = ("requested_start", "actual_end", "next_byte")
    REQUESTED_START_FIELD_NUMBER: _ClassVar[int]
    ACTUAL_END_FIELD_NUMBER: _ClassVar[int]
    NEXT_BYTE_FIELD_NUMBER: _ClassVar[int]
    requested_start: int
    actual_end: int
    next_byte: int
    def __init__(self, requested_start: _Optional[int] = ..., actual_end: _Optional[int] = ..., next_byte: _Optional[int] = ...) -> None: ...
