...
class SessionSubmissionKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SESSION_SUBMISSION_KIND_USER_TURN: _ClassVar[SessionSubmissionKind]
    SESSION_SUBMISSION_KIND_COMPACT: _ClassVar[SessionSubmissionKind]
...
SESSION_SUBMISSION_KIND_USER_TURN: SessionSubmissionKind
SESSION_SUBMISSION_KIND_COMPACT: SessionSubmissionKind

class SessionSubmission(_message.Message):
    __slots__ = ("submission_id", "session_id", "user_message_id", "status", "attempt_id", "claim_worker_id", "attempt_count", "claim_expires_at", "created_at", "updated_at", "completed_at", "committed_message_id", "current_phase", "current_journal_entry_id", "kind")
