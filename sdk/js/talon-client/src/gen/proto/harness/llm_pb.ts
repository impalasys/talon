...
export class ToolOutput extends Message<ToolOutput> {
   ...
   *
   * @generated from field: uint32 content_view_version = 4;
   */
  contentViewVersion = 0;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "content_view_version", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
  ]);
...
export class ToolOutputByteRange extends Message<ToolOutputByteRange> {
  /**
   * @generated from field: uint64 requested_start = 1;
   */
  requestedStart = protoInt64.zero;

  /**
   * @generated from field: uint64 actual_end = 2;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "requested_start", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "actual_end", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
