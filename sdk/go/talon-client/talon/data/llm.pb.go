...
const file_proto_harness_llm_proto_rawDesc = "" +
	...
	"\acontentJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"\xc2\x01\n" +
	"\n" +
	"ToolOutput\x12C\n" +
...
var file_proto_harness_llm_proto_depIdxs = []int32{
	...
	2,  // 2: talon.harness.ToolOutput.byte_range:type_name -> talon.harness.ToolOutputByteRange
	...
	10, // 5: talon.harness.ChatMessage.encrypted_reasoning:type_name -> talon.data.ObjectRef
	3,  // 6: talon.harness.ChatResponse.tool_calls:type_name -> talon.harness.ToolCall
	11, // 7: talon.harness.ChatResponse.usage:type_name -> talon.data.TokenCounter
	10, // 8: talon.harness.ChatResponse.encrypted_reasoning:type_name -> talon.data.ObjectRef
	5,  // 9: talon.harness.ChatRequest.messages:type_name -> talon.harness.ChatMessage
	7,  // 10: talon.harness.ChatRequest.tools:type_name -> talon.harness.Tool
	12, // 11: talon.harness.ChatRequest.thinking:type_name -> talon.resources.ThinkingConfig
	4,  // 12: talon.harness.ChatStreamEvent.tool_call_delta:type_name -> talon.harness.ToolCallDelta
	11, // 13: talon.harness.ChatStreamEvent.usage:type_name -> talon.data.TokenCounter
