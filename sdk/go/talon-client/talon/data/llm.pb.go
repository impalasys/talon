...
type ChatContentPart struct {
	...
	ByteRange     *ChatContentPartByteRange `protobuf:"bytes,5,opt,name=byte_range,json=byteRange,proto3,oneof" json:"byte_range,omitempty"`
...
func (x *ChatContentPart) GetByteRange() *ChatContentPartByteRange {
	if x != nil {
		return x.ByteRange
	}
	return nil
...
type ChatContentPartByteRange struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ChatContentPartByteRange) Reset() {
	*x = ChatContentPartByteRange{}
	mi := &file_proto_harness_llm_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChatContentPartByteRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChatContentPartByteRange) ProtoMessage() {}

func (x *ChatContentPartByteRange) ProtoReflect() protoreflect.Message {
	mi := &file_proto_harness_llm_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChatContentPartByteRange.ProtoReflect.Descriptor instead.
func (*ChatContentPartByteRange) Descriptor() ([]byte, []int) {
	return file_proto_harness_llm_proto_rawDescGZIP(), []int{1}
}

func (x *ChatContentPartByteRange) GetStart() uint64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *ChatContentPartByteRange) GetEnd() uint64 {
	if x != nil {
		return x.End
	}
	return 0
...
type ToolOutput struct {
	...
	ContentViewVersion uint32 `protobuf:"varint,4,opt,name=content_view_version,json=contentViewVersion,proto3" json:"content_view_version,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ToolOutput) GetContentViewVersion() uint32 {
	if x != nil {
		return x.ContentViewVersion
	}
	return 0
}
...
type ToolOutputByteRange struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RequestedStart uint64                 `protobuf:"varint,1,opt,name=requested_start,json=requestedStart,proto3" json:"requested_start,omitempty"`
	ActualEnd      uint64                 `protobuf:"varint,2,opt,name=actual_end,json=actualEnd,proto3" json:"actual_end,omitempty"`
...
func (x *ToolOutputByteRange) GetRequestedStart() uint64 {
	if x != nil {
...
func (x *ToolOutputByteRange) GetActualEnd() uint64 {
	if x != nil {
		return x.ActualEnd
	}
	return 0
...
const file_proto_harness_llm_proto_rawDesc = "" +
	"\n" +
	"\x17proto/harness/llm.proto\x12\rtalon.harness\x1a\x15proto/data/data.proto\x1a\x1cproto/resources/agents.proto\"\xd2\x01\n" +
	"\x0fChatContentPart\x12\x14\n" +
	"\x04text\x18\x01 \x01(\tH\x00R\x04text\x126\n" +
	"\n" +
	"object_ref\x18\x04 \x01(\v2\x15.talon.data.ObjectRefH\x00R\tobjectRef\x12K\n" +
	"\n" +
	"byte_range\x18\x05 \x01(\v2'.talon.harness.ChatContentPartByteRangeH\x01R\tbyteRange\x88\x01\x01B\t\n" +
	"\acontentB\r\n" +
	"\v_byte_rangeJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"B\n" +
	"\x18ChatContentPartByteRange\x12\x14\n" +
	"\x05start\x18\x01 \x01(\x04R\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\x04R\x03end\"\xf4\x01\n" +
	"\n" +
	"ToolOutput\x12C\n" +
	...
	"\n" +
	"byte_range\x18\x03 \x01(\v2\".talon.harness.ToolOutputByteRangeH\x00R\tbyteRange\x88\x01\x01\x120\n" +
	"\x14content_view_version\x18\x04 \x01(\rR\x12contentViewVersionB\r\n" +
	"\v_byte_range\"\x8d\x01\n" +
	"\x13ToolOutputByteRange\x12'\n" +
	"\x0frequested_start\x18\x01 \x01(\x04R\x0erequestedStart\x12\x1d\n" +
	"\n" +
	"actual_end\x18\x02 \x01(\x04R\tactualEnd\x12 \n" +
...
var file_proto_harness_llm_proto_goTypes = []any{
	...
	(*ChatContentPartByteRange)(nil), // 1: talon.harness.ChatContentPartByteRange
...
var file_proto_harness_llm_proto_depIdxs = []int32{
	...
	1,  // 1: talon.harness.ChatContentPart.byte_range:type_name -> talon.harness.ChatContentPartByteRange
	0,  // 2: talon.harness.ToolOutput.content_parts:type_name -> talon.harness.ChatContentPart
	3,  // 3: talon.harness.ToolOutput.byte_range:type_name -> talon.harness.ToolOutputByteRange
