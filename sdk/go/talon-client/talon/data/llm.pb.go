...
const file_proto_harness_llm_proto_rawDesc = "" +
	...
	"\ftotal_tokens\x18\x04 \x01(\x04R\vtotalTokens\"\xcf\x01\n" +
	...
	"\x05usage\x18\x03 \x01(\v2\x18.talon.harness.ChatUsageH\x00R\x05usage\x88\x01\x01\x12.\n" +
	...
	"\x05usage\x18\x04 \x01(\v2\x18.talon.harness.ChatUsageH\x00R\x05usage\x120\n" +
