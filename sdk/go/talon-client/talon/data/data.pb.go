...
var file_proto_data_data_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_proto_data_data_proto_goTypes = []any{
	...
	(*FileUpload)(nil),            // 4: talon.data.FileUpload
	(*HandleGrant)(nil),           // 5: talon.data.HandleGrant
	(*Principal)(nil),             // 6: talon.data.Principal
	(*SessionMessagePart)(nil),    // 7: talon.data.SessionMessagePart
	(*SessionMessage)(nil),        // 8: talon.data.SessionMessage
	(*Session)(nil),               // 9: talon.data.Session
	(*ChannelMessage)(nil),        // 10: talon.data.ChannelMessage
	(*Knowledge)(nil),             // 11: talon.data.Knowledge
	(*KnowledgeSearchResult)(nil), // 12: talon.data.KnowledgeSearchResult
	(*WorkflowRun)(nil),           // 13: talon.data.WorkflowRun
	(*WorkflowStepRun)(nil),       // 14: talon.data.WorkflowStepRun
	(*WorkflowRunEvent)(nil),      // 15: talon.data.WorkflowRunEvent
	nil,                           // 16: talon.data.ObjectRef.MetadataEntry
	nil,                           // 17: talon.data.Artifact.LabelsEntry
	nil,                           // 18: talon.data.Artifact.MetadataEntry
	nil,                           // 19: talon.data.FileUpload.RequiredHeadersEntry
	nil,                           // 20: talon.data.Principal.MetadataEntry
	nil,                           // 21: talon.data.SessionMessage.LabelsEntry
	nil,                           // 22: talon.data.Session.MetadataEntry
	nil,                           // 23: talon.data.Session.LabelsEntry
	nil,                           // 24: talon.data.ChannelMessage.LabelsEntry
	nil,                           // 25: talon.data.WorkflowRun.LabelsEntry
}
var file_proto_data_data_proto_depIdxs = []int32{
	16, // 0: talon.data.ObjectRef.metadata:type_name -> talon.data.ObjectRef.MetadataEntry
	2,  // 1: talon.data.Artifact.object_ref:type_name -> talon.data.ObjectRef
	17, // 2: talon.data.Artifact.labels:type_name -> talon.data.Artifact.LabelsEntry
	18, // 3: talon.data.Artifact.metadata:type_name -> talon.data.Artifact.MetadataEntry
	19, // 4: talon.data.FileUpload.required_headers:type_name -> talon.data.FileUpload.RequiredHeadersEntry
	20, // 5: talon.data.Principal.metadata:type_name -> talon.data.Principal.MetadataEntry
	1,  // 6: talon.data.SessionMessagePart.part_type:type_name -> talon.data.SessionMessagePartType
	2,  // 7: talon.data.SessionMessagePart.object:type_name -> talon.data.ObjectRef
	0,  // 8: talon.data.SessionMessage.role:type_name -> talon.data.MessageRole
	21, // 9: talon.data.SessionMessage.labels:type_name -> talon.data.SessionMessage.LabelsEntry
	7,  // 10: talon.data.SessionMessage.parts:type_name -> talon.data.SessionMessagePart
	22, // 11: talon.data.Session.metadata:type_name -> talon.data.Session.MetadataEntry
	23, // 12: talon.data.Session.labels:type_name -> talon.data.Session.LabelsEntry
	24, // 13: talon.data.ChannelMessage.labels:type_name -> talon.data.ChannelMessage.LabelsEntry
	25, // 14: talon.data.WorkflowRun.labels:type_name -> talon.data.WorkflowRun.LabelsEntry
