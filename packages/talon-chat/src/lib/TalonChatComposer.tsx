...
const composerVariantStyles: Record<TalonChatComposerVariant, TalonChatComposerVariantStyle> = {
  ...
  compact: {
    ...
    border: border("var(--copilot-input-compact-border, var(--copilot-input-border, rgba(212,212,216,0.72)))"),
    borderRadius: "var(--copilot-input-compact-radius, 16px)",
    boxShadow: "var(--copilot-input-compact-shadow, var(--copilot-input-shadow, 0 2px 8px rgba(24,24,27,0.07), 0 1px 2px rgba(24,24,27,0.05)))",
    buttonSize: 30,
    gap: 6,
    padding: "0.1875rem 0.25rem 0.1875rem 0.5rem",
    textareaPadding: "5px 0.3rem",
    background: "var(--copilot-input-compact-bg, var(--copilot-input-bg, rgba(255,255,255,0.96)))",
  },
  expanded: {
    attachmentRadius: 10,
    attachmentSize: 64,
    backdropFilter: "blur(18px)",
    border: border("var(--copilot-input-expanded-border, var(--copilot-input-border, rgba(212,212,216,0.78)))"),
    borderRadius: "var(--copilot-input-expanded-radius, 28px)",
    boxShadow: "var(--copilot-input-expanded-shadow, var(--copilot-input-shadow, 0 6px 18px rgba(24,24,27,0.06), 0 1px 2px rgba(24,24,27,0.05)))",
    buttonSize: 34,
    controlsBelow: true,
    gap: 8,
    minHeight: 110,
    ...
    background: "var(--copilot-input-expanded-bg, var(--copilot-input-bg, rgba(255,255,255,0.94)))",
  },
  inline: {
    attachmentRadius: 7,
    attachmentSize: 46,
    border: border("var(--copilot-input-inline-border, var(--copilot-input-border, rgba(212,212,216,0.64)))"),
    ...
    background: "var(--copilot-input-inline-bg, var(--copilot-input-bg, transparent))",
  },
};
