...
use talon::gateway::rpc::proto::{
    ...
    CreateNamespaceSkillRequest, CreateWorkflowRequest, CreateWorkflowRunRequest,
    DeleteAgentTemplateRequest, DeleteChannelRequest, DeleteChannelSubscriptionRequest,
    DeleteMcpServerRequest, DeleteNamespaceKnowledgeRequest, DeleteNamespaceSkillRequest,
    DeleteWorkflowRequest, GetAgentTemplateRequest, GetChannelRequest,
    GetChannelSubscriptionRequest, GetMcpServerRequest, GetNamespaceKnowledgeRequest,
    GetNamespaceSkillRequest, GetScheduleRequest, GetWorkflowRequest, GetWorkflowRunRequest,
