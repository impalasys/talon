...
use crate::harness::skills::loader::Skill;
...
mod tests {
    ...
    fn test_register_knowledge_tools() {
        let mut registry = ToolRegistry::new();
        crate::harness::knowledge::register_tools(&mut registry);

        assert!(registry
            .get_tool(crate::harness::knowledge::KNOWLEDGE_WRITE_TOOL)
            .is_some());
        assert!(registry
            .get_tool(crate::harness::knowledge::KNOWLEDGE_SEARCH_TOOL)
            .is_some());
        assert!(registry
            .get_tool(crate::harness::knowledge::KNOWLEDGE_GET_TOOL)
            .is_some());
        assert!(registry
            .get_tool(crate::harness::knowledge::KNOWLEDGE_LIST_TOOL)
            .is_some());
    }
}
